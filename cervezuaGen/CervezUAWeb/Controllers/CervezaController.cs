    ...
    public class CervezaController : BasicController
    {
        ...
        public ActionResult Edit(CervezaViewModel articulo)
        {
            try
            {
                ...
                cen.Modify(articulo.id, articulo.Nombre, articulo.Stock, articulo.Precio, articulo.ValMedia, articulo.Descripcion, articulo.Imagen, articulo.Marca, articulo.Graduacion, articulo.Unidades, articulo.Volumen, articulo.Tipo);
