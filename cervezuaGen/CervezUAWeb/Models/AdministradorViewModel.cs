...
namespace CervezUAWeb.Models
{
    public class AdministradorViewModel
    {
        ...
        [Display(Prompt = "Sueldo", Description = "Sueldo", Name = "Sueldo ")]
        [Required(ErrorMessage = "Debe indicar un sueldo")]
        [Range(minimum: 600, maximum: 6000, ErrorMessage = "El sueldo debe ser mayor que 600 y menor de 6000")]
